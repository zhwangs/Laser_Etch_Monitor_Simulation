...
GaAs_core = Layer(mat_GaAs, 273e-9)
#---------------------Bottom Mirror----------------------------------------------------
...
layers_ = (
    [air]
    + 15 * [ AlGaAs_DBR,GaAs_DBR]
    + [GaAs_core]
    + 22* [AlGaAs_DBR,GaAs_DBR]
    + [GaAs_substrate]
)
...
ax1.set_title(r"Reflectivity at laser monitor wavelength $\lambda = %0.1fnm$" % (wls[wlidx] * 1e9))
